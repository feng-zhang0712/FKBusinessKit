...
/// Local-only catalog for TabBarFilter examples (English copy).
enum FKTabBarFilterExampleStaticData {
  /// Two-column list: browse by top-level category.
  static let catalogTwoColumn: FKTabBarFilterTwoColumnModel = {
    let all = FKTabBarFilterTwoColumnModel.Category(id: .init(rawValue: "cat.all"), title: "All", isSelected: true)
    let regulations = FKTabBarFilterTwoColumnModel.Category(id: .init(rawValue: "cat.reg"), title: "Regulations", isSelected: false)
    let cases = FKTabBarFilterTwoColumnModel.Category(id: .init(rawValue: "cat.case"), title: "Cases", isSelected: false)
    let allSections: [FKTabBarFilterSection] = []
    let regulationSections: [FKTabBarFilterSection] = [
      .init(
    ...
    let caseSections: [FKTabBarFilterSection] = [
      .init(
    ...
    return FKTabBarFilterTwoColumnModel(
  ...
  static let trainingTwoColumn: FKTabBarFilterTwoColumnModel = {
    let leadership = FKTabBarFilterTwoColumnModel.Category(id: .init(rawValue: "tr.lead"), title: "Leadership", isSelected: true)
    let compliance = FKTabBarFilterTwoColumnModel.Category(id: .init(rawValue: "tr.comp"), title: "Compliance", isSelected: false)
    let skills = FKTabBarFilterTwoColumnModel.Category(id: .init(rawValue: "tr.skill"), title: "Professional skills", isSelected: false)
    let webSchool = FKTabBarFilterTwoColumnModel.Category(id: .init(rawValue: "tr.web"), title: "Web school", isSelected: false)
    let simpleAll: [FKTabBarFilterSection] = [
      .init(id: .init(rawValue: "tr.all"), selectionMode: .single, items: [.init(id: .init(rawValue: "tr.all.item"), title: "All", isSelected: true)]),
    ]
    let webSections: [FKTabBarFilterSection] = [
      .init(
  ...
  static let fileTypeSections: [FKTabBarFilterSection] = [
    .init(
  ...
  static let platformSections: [FKTabBarFilterSection] = [
    .init(
  ...
  static let tagsSections: [FKTabBarFilterSection] = [
    .init(
  ...
  static let sortSection: FKTabBarFilterSection = .init(
