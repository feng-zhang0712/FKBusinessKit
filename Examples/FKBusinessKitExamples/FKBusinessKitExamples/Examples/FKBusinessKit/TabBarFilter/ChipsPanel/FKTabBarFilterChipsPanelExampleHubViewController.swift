...
final class FKTabBarFilterChipsPanelExampleHubViewController: UITableViewController {

  private static let sectionSpec: [(title: String, examples: [FKTabBarFilterChipsPanelExampleCase])] = [
    (
      "Structure & selection",
      [
  ...
  override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    navigationController?.pushViewController(
      FKTabBarFilterChipsPanelExampleDetailViewController(exampleCase: exampleCase),
      animated: true
    )
  }
}
