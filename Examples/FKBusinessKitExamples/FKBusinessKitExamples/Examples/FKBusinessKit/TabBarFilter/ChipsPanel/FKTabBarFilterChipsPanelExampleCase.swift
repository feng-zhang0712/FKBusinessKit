...
struct FKTabBarFilterChipsPanelExamplePanelSpec {
  let sections: [FKTabBarFilterSection]
  let configuration: FKTabBarFilterChipsViewController.Configuration
  let allowsMultipleSelection: Bool
  let deliversSelectionEvents: Bool
}

enum FKTabBarFilterChipsPanelExampleCase: Int, CaseIterable {
  ...
  func makeSpec() -> FKTabBarFilterChipsPanelExamplePanelSpec {
    switch self {
    case .baselineSingleSection:
    ...
    case .customPillStyle:
      let pill = FKTabBarFilterPillStyle(
        cornerRadius: 14,
  ...
  private static func oneSectionChips() -> [FKTabBarFilterSection] {
    [
      FKTabBarFilterSection(
        id: FKTabBarFilterID(rawValue: "chip.sec1"),
        title: nil,
        selectionMode: .single,
        items: [
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "c1"), title: "Alpha", isSelected: true),
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "c2"), title: "Beta", isSelected: false),
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "c3"), title: "Gamma", isSelected: false),
        ]
      ),
    ]
  }

  private static func twoSectionChips() -> [FKTabBarFilterSection] {
    [
      FKTabBarFilterSection(
        id: FKTabBarFilterID(rawValue: "cs1"),
        title: nil,
        selectionMode: .single,
        items: [
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "x1"), title: "Small", isSelected: true),
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "x2"), title: "Medium", isSelected: false),
        ]
      ),
      FKTabBarFilterSection(
        id: FKTabBarFilterID(rawValue: "cs2"),
        title: nil,
        selectionMode: .single,
        items: [
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "x3"), title: "Large", isSelected: false),
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "x4"), title: "XL", isSelected: false),
        ]
      ),
    ]
  }

  private static func multiSectionChips() -> [FKTabBarFilterSection] {
    [
      FKTabBarFilterSection(
        ...
        items: [
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "m1a"), title: "A", isSelected: false),
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "m1b"), title: "B", isSelected: true),
        ]
      ),
      FKTabBarFilterSection(
        ...
        selectionMode: .multiple,
        items: [
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "m2a"), title: "C", isSelected: false),
        ]
      ),
    ]
  }

  private static func manyChips() -> [FKTabBarFilterSection] {
    let items = (1 ... 18).map { i in
      FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "n.\(i)"), title: "Chip \(i)", isSelected: i == 1)
    }
    return [
      FKTabBarFilterSection(id: FKTabBarFilterID(rawValue: "many"), title: nil, selectionMode: .single, items: items),
    ]
  }

  private static func disabledChipSection() -> [FKTabBarFilterSection] {
    [
      FKTabBarFilterSection(
        id: FKTabBarFilterID(rawValue: "dis"),
        title: nil,
        selectionMode: .single,
        items: [
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "d1"), title: "OK", isSelected: true),
          FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "d2"), title: "Off", isSelected: false, isEnabled: false),
        ]
      ),
    ]
  }
