...
final class FKTabBarFilterTwoColumnGridExampleHubViewController: UITableViewController {

  private static let sectionSpec: [(title: String, examples: [FKTabBarFilterTwoColumnGridExampleCase])] = [
    (
      "Baseline",
      [.baselineDefaults]
    ),
  ...
  override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    navigationController?.pushViewController(
      FKTabBarFilterTwoColumnGridExampleDetailViewController(exampleCase: exampleCase),
      animated: true
    )
  }
}
