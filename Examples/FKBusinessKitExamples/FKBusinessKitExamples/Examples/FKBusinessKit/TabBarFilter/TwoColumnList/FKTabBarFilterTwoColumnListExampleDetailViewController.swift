...
/// Hosts a single ``FKTabBarFilterTwoColumnListViewController`` plus a small event log.
final class FKTabBarFilterTwoColumnListExampleDetailViewController: UIViewController {

  private let exampleCase: FKTabBarFilterTwoColumnListExampleCase
  private let logView = UITextView()
  private let panelContainer = UIView()
  private var panel: FKTabBarFilterTwoColumnListViewController?

  init(exampleCase: FKTabBarFilterTwoColumnListExampleCase) {
  ...
  private func installPanel() {
    ...
    let panelVC = FKTabBarFilterTwoColumnListViewController(
      model: spec.model,
