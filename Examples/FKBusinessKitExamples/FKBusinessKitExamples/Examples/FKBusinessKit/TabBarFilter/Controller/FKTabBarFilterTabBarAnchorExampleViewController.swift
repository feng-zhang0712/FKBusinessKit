...
/// Filter strip anchored to **`FKTabBar`** (default). Tabs, switch animations, callbacks — no custom anchor APIs.
///
...
final class FKTabBarFilterTabBarAnchorExampleViewController: UIViewController {
  ...
  private lazy var filter: FKTabBarFilterController<FKTabBarFilterExampleTabID> = {
    FKTabBarFilterThreeTabScenario.makeController(tabBarHost: host) { [weak self] line in
      self?.appendLog(line)
    }
  }()
