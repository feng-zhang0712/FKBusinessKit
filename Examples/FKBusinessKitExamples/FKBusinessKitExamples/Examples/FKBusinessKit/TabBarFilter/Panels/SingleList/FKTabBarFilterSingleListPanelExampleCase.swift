...
struct FKTabBarFilterSingleListPanelExamplePanelSpec {
  let section: FKTabBarFilterSection
  let configuration: FKTabBarFilterSingleListViewController.Configuration
  let allowsMultipleSelection: Bool
  let deliversSelectionEvents: Bool
}

enum FKTabBarFilterSingleListPanelExampleCase: Int, CaseIterable {
  case baselineSingle
  ...
  func makeSpec() -> FKTabBarFilterSingleListPanelExamplePanelSpec {
    switch self {
    case .baselineSingle:
    ...
    case .multipleSelection:
      return .init(
        section: FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "sl.multi"),
          title: nil,
          selectionMode: .multiple,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "m1"), title: "Alpha", isSelected: true),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "m2"), title: "Beta", isSelected: false),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "m3"), title: "Gamma", isSelected: true),
          ]
        ),
        configuration: .init(),
    ...
    case .subtitles:
      return .init(
        section: FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "sl.sub"),
          title: nil,
          selectionMode: .single,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "s1"), title: "Newest", subtitle: "Posted recently", isSelected: true),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "s2"), title: "Hottest", subtitle: "Most engagement", isSelected: false),
          ]
        ),
        configuration: .init(),
    ...
    case .attributedTitle:
      ...
      return .init(
        section: FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "sl.attr"),
          title: nil,
          selectionMode: .single,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "a1"), title: "Plain", attributedTitle: attr, isSelected: true),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "a2"), title: "Other", isSelected: false),
          ]
        ),
        configuration: .init(),
        allowsMultipleSelection: false,
    ...
    case .disabledRow:
      return .init(
        section: FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "sl.dis"),
          title: nil,
          selectionMode: .single,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "d1"), title: "Available", isSelected: true),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "d2"), title: "Unavailable", isSelected: false, isEnabled: false),
          ]
        ),
        configuration: .init(),
        allowsMultipleSelection: false,
    ...
    case .darkCellStyle:
      let style = FKTabBarFilterListCellStyle(
  ...
  private static func basicSection() -> FKTabBarFilterSection {
    FKTabBarFilterSection(
      id: FKTabBarFilterID(rawValue: "sl.base"),
      title: nil,
      selectionMode: .single,
      items: [
        FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "b1"), title: "Option A", isSelected: true),
        FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "b2"), title: "Option B", isSelected: false),
        FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "b3"), title: "Option C", isSelected: false),
      ]
    )
  }

  private static func tallSection() -> FKTabBarFilterSection {
    let items = (1 ... 12).map { i in
      FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "t.\(i)"), title: "Sort option \(i)", isSelected: i == 1)
    }
    return FKTabBarFilterSection(id: FKTabBarFilterID(rawValue: "sl.tall"), title: nil, selectionMode: .single, items: items)
  }
}
