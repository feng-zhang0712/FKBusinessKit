...
struct FKTabBarFilterTwoColumnGridExamplePanelSpec {
  let model: FKTabBarFilterTwoColumnModel
  let configuration: FKTabBarFilterTwoColumnGridViewController.Configuration
  let allowsMultipleSelection: Bool
  let deliversSelectionEvents: Bool
}

enum FKTabBarFilterTwoColumnGridExampleCase: Int, CaseIterable {
  ...
  func makeSpec() -> FKTabBarFilterTwoColumnGridExamplePanelSpec {
    switch self {
    case .baselineDefaults:
  ...
  private static func gridCatalogModel() -> FKTabBarFilterTwoColumnModel {
    let categories = [
      FKTabBarFilterTwoColumnModel.Category(id: catA, title: "Topics", isSelected: true),
    ]
    let sections: [FKTabBarFilterID: [FKTabBarFilterSection]] = [
      catA: [
        FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "g.sec1"),
          title: "Popular",
          selectionMode: .single,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "g1"), title: "Swift", isSelected: true),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "g2"), title: "UIKit", isSelected: false),
          ]
        ),
        FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "g.sec2"),
          title: "More",
          selectionMode: .single,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "g3"), title: "Combine", isSelected: false),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "g4"), title: "Concurrency", isSelected: false),
          ]
        ),
      ],
    ]
  ...
  private static func gridCollapseModel() -> FKTabBarFilterTwoColumnModel {
    let categories = [FKTabBarFilterTwoColumnModel.Category(id: catA, title: "Topics", isSelected: true)]
    let sections: [FKTabBarFilterID: [FKTabBarFilterSection]] = [
      catA: [
        FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "gc1"),
          title: "Open section",
          selectionMode: .single,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "gc1a"), title: "A", isSelected: true),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "gc1b"), title: "B", isSelected: false),
          ],
          isCollapsed: false
        ),
        FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "gc2"),
          title: "Collapsed initially",
          selectionMode: .single,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "gc2a"), title: "C", isSelected: false),
          ],
          isCollapsed: true
        ),
      ],
  ...
  private static func gridScopeModel() -> FKTabBarFilterTwoColumnModel {
    let categories = [FKTabBarFilterTwoColumnModel.Category(id: catA, title: "Scope", isSelected: true)]
    let sections: [FKTabBarFilterID: [FKTabBarFilterSection]] = [
      catA: [
        FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "gs1"),
          title: "Block A",
          selectionMode: .single,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "gs1a"), title: "A1", isSelected: true),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "gs1b"), title: "A2", isSelected: false),
          ]
        ),
        FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "gs2"),
          title: "Block B",
          selectionMode: .single,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "gs2a"), title: "B1", isSelected: false),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "gs2b"), title: "B2", isSelected: false),
          ]
        ),
      ],
    ]
  ...
  private static func gridMultiModel() -> FKTabBarFilterTwoColumnModel {
    let categories = [FKTabBarFilterTwoColumnModel.Category(id: catA, title: "Tags", isSelected: true)]
    let sections: [FKTabBarFilterID: [FKTabBarFilterSection]] = [
      catA: [
        FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "gm1"),
          title: "Set A",
          selectionMode: .multiple,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "t1"), title: "One", isSelected: false),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "t2"), title: "Two", isSelected: true),
          ]
        ),
        FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "gm2"),
          title: "Set B",
          selectionMode: .multiple,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "t3"), title: "Three", isSelected: false),
          ]
        ),
      ],
    ]
  ...
  private static func gridTallModel() -> FKTabBarFilterTwoColumnModel {
    let items = (1 ... 18).map { i in
      FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "tall.\(i)"), title: "Item \(i)", isSelected: i == 1)
    }
    let categories = [FKTabBarFilterTwoColumnModel.Category(id: catA, title: "Tall", isSelected: true)]
    let sections: [FKTabBarFilterID: [FKTabBarFilterSection]] = [
      catA: [
        FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "gt"),
          title: "Many pills",
          selectionMode: .single,
          items: items
        ),
  ...
  private static func gridManyItemsModel() -> FKTabBarFilterTwoColumnModel {
    let items = (1 ... 16).map { i in
      FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "m.\(i)"), title: "\(i)", isSelected: i == 1)
    }
    let categories = [FKTabBarFilterTwoColumnModel.Category(id: catA, title: "Grid", isSelected: true)]
    let sections: [FKTabBarFilterID: [FKTabBarFilterSection]] = [
      catA: [
  ...
  private static func gridDisabledModel() -> FKTabBarFilterTwoColumnModel {
    let categories = [FKTabBarFilterTwoColumnModel.Category(id: catA, title: "State", isSelected: true)]
    let sections: [FKTabBarFilterID: [FKTabBarFilterSection]] = [
      catA: [
        FKTabBarFilterSection(
          id: FKTabBarFilterID(rawValue: "gd"),
          title: "Options",
          selectionMode: .single,
          items: [
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "ok"), title: "Enabled", isSelected: true),
            FKTabBarFilterOptionItem(id: FKTabBarFilterID(rawValue: "no"), title: "Disabled", isSelected: false, isEnabled: false),
          ]
        ),
      ],
    ]
