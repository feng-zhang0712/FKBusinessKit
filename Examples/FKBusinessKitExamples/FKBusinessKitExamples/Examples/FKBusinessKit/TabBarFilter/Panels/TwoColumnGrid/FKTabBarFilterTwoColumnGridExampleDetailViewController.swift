...
final class FKTabBarFilterTwoColumnGridExampleDetailViewController: UIViewController {

  private let exampleCase: FKTabBarFilterTwoColumnGridExampleCase
  private let logView = UITextView()
  private let panelContainer = UIView()

  init(exampleCase: FKTabBarFilterTwoColumnGridExampleCase) {
  ...
  override func viewDidLoad() {
    ...
    let panel = FKTabBarFilterTwoColumnGridViewController(
      model: spec.model,
