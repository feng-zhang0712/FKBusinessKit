...
/// Shared off-screen ``FKTabBar`` host with a visible anchor control for dropdown demos.
final class FKTabBarFilterExampleAnchorHostView: UIView, FKTabBarFilterTabBarHost {
  ...
  init(placement: Placement, title: String) {
    ...
    if placement == .interactive {
      ...
      anchorControl.accessibilityHint = "Toggles the Filters dropdown anchored below this bar."
    }
    commonInit()
  }
...
typealias FKTabBarFilterZoneAnchorHostView = FKTabBarFilterExampleAnchorHostView
