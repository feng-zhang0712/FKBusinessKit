...
final class FKTabBarFilterDropdownExamplesHubViewController: UITableViewController {

  private static let sectionSpec: [(title: String, examples: [FKTabBarFilterDropdownAnchoredExample])] = [
    (
      "Tab strip & panel mix",
      [.scrollableSixPanels]
    ),
  ...
  override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    navigationController?.pushViewController(
      FKTabBarFilterDropdownAnchoredExampleViewController(anchoredExample: example),
      animated: true
    )
  }
}
