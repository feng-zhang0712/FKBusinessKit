...
final class FKTabBarFilterSingleListPanelExampleHubViewController: UITableViewController {

  private static let sectionSpec: [(title: String, examples: [FKTabBarFilterSingleListPanelExampleCase])] = [
    (
      "Selection",
      [
        .baselineSingle,
  ...
  override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    navigationController?.pushViewController(
      FKTabBarFilterSingleListPanelExampleDetailViewController(exampleCase: exampleCase),
      animated: true
    )
  }
}
