...
final class FKTabBarFilterHorizontalEdgeNoteViewController: UIViewController {
  override func viewDidLoad() {
    ...
    Left- and right-attached trays are available on FKSheetPresentationConfiguration.Layout.edge(_:) in FKUIKit, but TabBarFilter does not expose that layout mode — the dropdown controller always uses anchor hosting for tab-attached panels.
