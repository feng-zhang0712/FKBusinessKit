...
/// Demonstrates ``FKBaseTableViewController``: pull-to-refresh, load-more, and prefetch.
final class FKBaseTableBasicsExampleViewController: FKBusinessKitBase.TableViewController, UITableViewDataSource {
...
extension FKBaseTableBasicsExampleViewController: UITableViewDataSourcePrefetching {
