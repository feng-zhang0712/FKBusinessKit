...
final class FKBaseCompositionExampleViewController: UIViewController,
  FKBusinessKitBase.ViewControllerBuildPhases,
  FKBusinessKitBase.ViewControllerCompositeHosting,
  FKBusinessKitBase.ViewControllerTraitChangeHandling {

  let composite = FKBusinessKitBase.ViewControllerComposite()
