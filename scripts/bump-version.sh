...
new="${1:?Usage: $0 <semver> (e.g. 0.1.0)}"
...
echo "  4. After the tag exists on the remote, run pod spec lint on the podspec (see README / docs/RELEASING.md)."
