...
///
/// Usage:
/// - Typically created by ``FKTabBarFilterPanelFactory`` when ``FKTabBarFilterPanelFactory/wrapsPanelWithTopHairline`` is true.
final class FKTabBarFilterTopHairlineWrapperViewController: UIViewController {
