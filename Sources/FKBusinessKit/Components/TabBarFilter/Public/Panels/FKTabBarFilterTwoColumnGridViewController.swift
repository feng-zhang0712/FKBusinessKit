...
final class FKTabBarFilterTwoColumnGridCell: UICollectionViewCell {
  static let reuseID = "FKTabBarFilterTwoColumnGridCell"
  ...
  func apply(item: FKTabBarFilterOptionItem, style: FKTabBarFilterPillStyle) {
...
final class FKTabBarFilterTwoColumnGridHeaderView: UICollectionReusableView {
  static let reuseID = "FKTabBarFilterTwoColumnGridHeaderView"
  ...
  func apply(
    title: String,
    style: FKTabBarFilterTwoColumnGridViewController.Configuration.RightHeaderStyle,
...
/// - Right side groups options by `FKTabBarFilterSection` and renders items as pill buttons in a grid.
...
/// - Single-select scope: ``FKTabBarFilterTwoColumnSingleSelectionScope`` (typealias ``SingleSelectionScope``).
///
/// Use when you want:
/// - Better density than a table list
/// - Reusable cells and smooth scrolling for larger datasets
public final class FKTabBarFilterTwoColumnGridViewController: UIViewController {
  public typealias LeftCellContentConfiguration = (
    _ cell: UITableViewCell,
    _ indexPath: IndexPath,
    _ category: FKTabBarFilterTwoColumnModel.Category
  ) -> Void
  ...
  public typealias SingleSelectionScope = FKTabBarFilterTwoColumnSingleSelectionScope

  public struct Configuration {
    public typealias RightHeaderStyle = FKTabBarFilterTwoColumnRightHeaderStyle

    public var leftRowHeight: CGFloat
    public var leftColumnWidthRatio: CGFloat
    public var leftCellStyle: FKTabBarFilterListCellStyle
    ...
    public var pillStyle: FKTabBarFilterPillStyle
    ...
    public var rightSectionHeaderBehavior: FKTabBarFilterTwoColumnRightSectionHeaderBehavior
    ...
    public init(
      ...
      leftCellStyle: FKTabBarFilterListCellStyle = .init(
      ...
      itemColumns: Int = 2,
      pillStyle: FKTabBarFilterPillStyle = .init(cornerRadius: 6, contentInsets: .init(top: 8, left: 10, bottom: 8, right: 10)),
  ...
  private var model: FKTabBarFilterTwoColumnModel
  private let configuration: Configuration
  private let onChange: (FKTabBarFilterTwoColumnModel) -> Void
  private let onSelection: ((FKTabBarFilterPanelSelection) -> Void)?
  private let allowsMultipleSelection: Bool
  private var selectedHeaderSectionID: FKTabBarFilterID?
  ...
  private lazy var rightCollectionView: UICollectionView = {
    ...
    cv.register(FKTabBarFilterTwoColumnGridCell.self, forCellWithReuseIdentifier: FKTabBarFilterTwoColumnGridCell.reuseID)
    cv.register(
      FKTabBarFilterTwoColumnGridHeaderView.self,
      forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader,
      withReuseIdentifier: FKTabBarFilterTwoColumnGridHeaderView.reuseID
    )
    return cv
  }()
  ...
  public init(
    ...
    onChange: @escaping (FKTabBarFilterTwoColumnModel) -> Void,
  ...
  private var selectedCategoryID: FKTabBarFilterID? {
    model.categories.first(where: \.isSelected)?.id
  }

  private func rightSections() -> [FKTabBarFilterSection] {
  ...
  private func handleHeaderTap(sectionIndex: Int) {
    ...
    onSelection?(
      .init(
        sectionID: target.id,
        item: FKTabBarFilterOptionItem(id: target.id, title: target.title ?? "", isSelected: true),
...
extension FKTabBarFilterTwoColumnGridViewController: UITableViewDataSource, UITableViewDelegate {
...
extension FKTabBarFilterTwoColumnGridViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
  ...
  public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    let cell = collectionView.dequeueReusableCell(withReuseIdentifier: FKTabBarFilterTwoColumnGridCell.reuseID, for: indexPath)
    guard let gridCell = cell as? FKTabBarFilterTwoColumnGridCell else { return cell }
  ...
  public func collectionView(
    ...
    guard
      let header = view as? FKTabBarFilterTwoColumnGridHeaderView
    else {
      return view
    }
    let section = rightSections()[indexPath.section]
