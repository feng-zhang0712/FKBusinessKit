...
final class FKTabBarFilterChipCell: UICollectionViewCell {
  static let reuseID = "FKTabBarFilterChipCell"
  ...
  func apply(_ item: FKTabBarFilterOptionItem, style: FKTabBarFilterPillStyle) {
...
public final class FKTabBarFilterChipsViewController: UIViewController {
  public struct Configuration {
    ...
    public init(
      ...
      heightBehavior: FKTabBarFilterPanelHeightBehavior = .automatic(minimum: 80),
      pillStyle: FKTabBarFilterPillStyle = .init()
    ) {
  ...
  private var sections: [FKTabBarFilterSection]
  ...
  private lazy var collectionView: UICollectionView = {
    ...
    cv.register(FKTabBarFilterChipCell.self, forCellWithReuseIdentifier: FKTabBarFilterChipCell.reuseID)
    cv.dataSource = self
    cv.delegate = self
...
extension FKTabBarFilterChipsViewController: UICollectionViewDataSource {
  ...
  public func collectionView(
    ...
    let cell = collectionView.dequeueReusableCell(withReuseIdentifier: FKTabBarFilterChipCell.reuseID, for: indexPath)
    guard let chip = cell as? FKTabBarFilterChipCell else { return cell }
    chip.apply(sections[indexPath.section].items[indexPath.item], style: config.pillStyle)
    return chip
  }
}

extension FKTabBarFilterChipsViewController: UICollectionViewDelegateFlowLayout {
  public func collectionView(
    _ collectionView: UICollectionView,
