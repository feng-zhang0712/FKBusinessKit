...
/// Right-hand ``UITableView`` section header used by ``FKTabBarFilterTwoColumnListViewController`` when
/// ``Configuration/rightSectionHeaderBehavior`` is not ``FKTabBarFilterTwoColumnRightSectionHeaderBehavior/standard``.
/// Mirrors ``FKTabBarFilterTwoColumnGridHeaderView`` tap + disclosure rules.
final class FKTabBarFilterTwoColumnListSectionHeaderView: UIView {
  ...
  func apply(
    title: String,
    style: FKTabBarFilterTwoColumnListViewController.RightHeaderStyle,
