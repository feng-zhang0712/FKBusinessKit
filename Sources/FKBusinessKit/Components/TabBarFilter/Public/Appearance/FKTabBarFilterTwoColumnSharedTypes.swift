...
/// ``FKTabBarFilterTwoColumnListViewController`` or ``FKTabBarFilterTwoColumnGridViewController``.
public enum FKTabBarFilterTwoColumnSingleSelectionScope: Hashable, Sendable {
