...
///
/// Used by:
/// - `FKTabBarFilterSingleListViewController` (single list panel)
/// - `FKTabBarFilterTwoColumnListViewController` (left/right tables)
///
/// Naming note:
/// - `FKTabBarFilterListCellStyle` is OK because the underlying UI is table/“cell”-like.
/// - If you want a more abstract name, `FKTabBarFilterListItemStyle` is a good alternative.
///   (I did NOT rename it to avoid breaking API.)
public struct FKTabBarFilterListCellStyle {
