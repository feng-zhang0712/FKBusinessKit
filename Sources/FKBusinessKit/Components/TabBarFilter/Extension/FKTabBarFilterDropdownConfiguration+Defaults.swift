...
public extension FKTabBarFilterDropdownConfiguration {
  /// Default configuration tuned for an anchored dropdown below a top tab bar.
  @MainActor
  static var `default`: FKTabBarFilterDropdownConfiguration {
  ...
  /// (`label` / `secondaryLabel`). Typical for chevron-style filter tabs from ``FKTabBarFilterDropdownTab``.
