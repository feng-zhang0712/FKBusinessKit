...
[![Version](https://img.shields.io/badge/version-0.4.0-blue.svg)](https://github.com/feng-zhang0712/FKBusinessKit/releases/tag/0.4.0)
...
### Xcode
1. Add **FKBusinessKit**: `https://github.com/feng-zhang0712/FKBusinessKit.git` (from `0.4.0`)
...
```swift
dependencies: [
  .package(url: "https://github.com/feng-zhang0712/FKBusinessKit.git", from: "0.4.0"),
],
targets: [
  .target(
    name: "YourTarget",
...
pod 'FKBusinessKit', :git => 'https://github.com/feng-zhang0712/FKBusinessKit.git', :tag => '0.4.0'
```
